...
def _bridge_health():
    ...
    with BRIDGE_CACHE_LOCK:
        ...
        for key, (service, repo) in BRIDGE_SERVICES.items():
            ...
            # independent VITROS verifier queue is external to PROJECT_BYTE, so
            # it is process-observable here but has no trustworthy local pending
            # record to correlate without adding a prohibited network call.
            ...
            result[key] = _evaluate_bridge_health(
